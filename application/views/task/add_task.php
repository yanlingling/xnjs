...
<form id="<?php echo $genid ?>submit-edit-form" style='height:100%;background-color:white'
      class="internalForm" action="<?php echo $task->isNew() ? get_url('task', 'add_task', array("copyId" => array_var($task_data, 'copyId'))) : $task->getEditListUrl() ?>" method="post" onsubmit="return og.checkSubmitAddTask('<?php echo $genid ?>')">
...
<div class="coInputHeader">
	...
	?>
        ...
        <td style="text-align:right">
            <?php echo submit_button($task->isNew() ?
                (array_var($task_data, 'is_template', false) ? lang('save template') : lang('add task list'))
                : lang('save changes'),'s',array('style'=>'margin-top:0px;margin-left:10px', 'tabindex' => '10')) ?>
        </td>
    </tr>
        </table>
	</div>
...
<div class="coInputMainBlock">
    ...
    <legend><?php echo lang('task data') ?></legend>
	    ...
	    <label style="display: none"><?php echo lang('milestone') ?>: <span class="desc">(<?php echo lang('assign milestone task list desc') ?>)</span></label>
	    
	    <div style="float:left;display: none" id="<?php $genid ?>add_task_more_div_milestone_combo" >
    	...
    	<table><tbody>
            <tr style="display: none"><td style="padding-right: 10px">
		...
		<div id='<?php echo $genid ?>add_task_time_div' style="padding-top:6px;display: none">
