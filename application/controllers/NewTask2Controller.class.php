 ...
 */
class Newtask2Controller extends ApplicationController
{
    ...
    function content()
    {
        ...
        if (isset($_GET['depart_id'])) {
            $sql = "SELECT y.depart_id,y.depart_name,y.law_task
    ...
    function add_law_task()
    {
        ...
        if (isset($_GET['opt']) && $_GET['opt'] == 'add') {
            ...
            $sql = "update og_department set law_task = '" . $_POST['content'] . "'
