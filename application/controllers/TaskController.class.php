...
class TaskController extends ApplicationController {
    ...
    function delay_apply_list(){
        ...
        DB::beginWork();
       $sql = "SELECT x.id,x.reason, y.title, x.hope_day, x.agree_day, x.status,x.create_time, x.handle_time,z.username
