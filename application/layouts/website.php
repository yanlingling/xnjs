				...
				<table><tr><td>
					<div id="wsCrumbsDiv">
						<div style="font-size:150%;display:inline;">
							<a href="#" id='company-name' style="display:inline;line-height:28px;color: #ffffff" >赣榆县食品药品监督管理局</a>
                            <a id="crumbs-depart-name"></a>
						</div>
					</div>
				</td><td>
...
<div id="footer">
	<div id="copy">
        <?php echo lang('footer copy without homepage', date('Y'), '赣榆县食品药品监督管理局') ?>

	</div>
	<div id="productSignature">技术支持：大连威迪欧信息技术有限公司</div>
</div>
<!-- /footer -->
...
og.loggedUser = {
    ...
    userRole:'<?php echo logged_user()->getUserRole() ?>'
};
