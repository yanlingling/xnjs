<?php return array(
	...
	'config option name enable_notes_module' => '启用工作计划/总结模块',
	...
	'user ws config option name show messages widget' => '显示工作计划/总结的小工具',
	...
	'cron events' => '定时事项',
	'about cron events' => '关于定时事项...',
	'cron events info' => '定时事项可以让你在Feng Office中定期执行任务，而不需要登录到系统中。为了启用定时事项你需要配置一个定时作业来周期性的执行文件："cron.php"，这个文件在Feng Office的根目录下面。这个你运行定时作业的周期决定了你可以运行定时事项的最小时间间隔。 例如：如果你配置定时作业每5分钟一次，并且你配置检查更新的定时事项为每分钟一次， 那么实际上将每5分钟检查一次更新。如何配置定时作业请询问你的系统管理员或者主机提供商。',
	'cron event name check_mail' => '检查邮件',
	'cron event desc check_mail' => '这个定时事项将检查所有系统中电子邮件帐户中的新邮件。',
	'cron event name purge_trash' => '清理回收站',
	'cron event desc purge_trash' => '这个定时事项将删除超期的回收站中的对象。',
	'cron event name send_reminders' => '发送提醒',
	'cron event desc send_reminders' => '这个定时事项将自动发送电子邮件提醒。',
	'cron event name check_upgrade' => '检查更新',
	'cron event desc check_upgrade' => '这个定时事项将检测Feng Office的新版本。',
	...
	'enabled' => '启用',
	'no cron events to display' => '没有定时事项显示',
	...
	'cron event desc send_notifications_through_cron' => '若此事项开启，邮件提醒将通过cron发送，而不是当系统生成事项时发送。',
